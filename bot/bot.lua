...
]]..'\27[0;31m'..[[@ARRAB_H1]]..'\27[m'..[[ 
                                              
]]..'\27[0;31m'..[[@DevJason]]..'\27[m'..[[   
                                            
]]..'\27[0;31m'..[[@ARRAB_H1]]..'\27[m'..[[  
                                             
]]..'\27[0;31m'..[[@العراب..'\27[m'..[[                                               
...
redis:set(string.sub(token,0,9)..'bot:name',botname)
	...
	info_text = [[❖￤ اهلا بك في سورس العراب 🔎
...
./libs/tg -s ./bot/sy.lua $@ --bot=$token
...
sleep(3)
os.execute(' rm -fr data/config.lua && lua bot/sy.lua ')
return
end
end
...
sy = string.sub(_config.token,0,9)
