...
do 
local update = 18; --  رقم اصدار السورس 
...
for k, v in pairs( plugins_names( )) do  
v = string.match (v, "(.*)%.lua") 
tdcli.sendDocument(msg.chat_id_, msg.id_,0, 1, nil, "./plugins/"..v..".lua", '❖￤ الملف مقدم من قناه  العراب ❖￤ \n❖￤ تابع قناة السورس @DevJason\n👨🏽‍🔧', dl_cb, nil)
end 
else
if not plugin_exists(matches[2]) then 
return '❖￤ لا يوجد ملف بهذا الاسم .\n\n'
else 
tdcli.sendDocument(msg.chat_id_, msg.id_,0, 1, nil, "./plugins/"..matches[2]..".lua", '❖￤ الملف مقدم من قناه  العراب ❖￤ \n❖￤ تابع قناة السورس @DevJason\n👨🏽‍🔧', dl_cb, nil)
end end end
...
tdcli.sendDocument(msg.chat_id_, msg.id_,0, 1, nil, send_file, '❖￤ الملف مقدم من قناه  العراب ❖￤ \n❖￤ تابع قناة السورس @DevJason\n👨🏽‍🔧', dl_cb, nil)
end
...
download_to_file('https://raw.githubusercontent.com/moody2020/sy/master/plugins/banhammer.lua','./plugins/banhammer.lua')
download_to_file('https://raw.githubusercontent.com/moody2020/sy/master/plugins/groupmanager.lua','./plugins/groupmanager.lua')
download_to_file('https://raw.githubusercontent.com/moody2020/sy/master/plugins/dell.lua','./plugins/dell.lua')
download_to_file('https://raw.githubusercontent.com/moody2020/sy/master/plugins/msg_checks.lua','./plugins/msg_checks.lua')
download_to_file('https://raw.githubusercontent.com/moody2020/sy/master/plugins/plugins.lua','./plugins/plugins.lua')
download_to_file('https://raw.githubusercontent.com/moody2020/sy/master/plugins/replay.lua','./plugins/replay.lua')
download_to_file('https://raw.githubusercontent.com/moody2020/sy/master/plugins/tools.lua','./plugins/tools.lua')
download_to_file('https://raw.githubusercontent.com/moody2020/sy/master/plugins/zhrf.lua','./plugins/zhrf.lua')

  plugins = {} 
  load_plugins() 
return "🤖¦ تم تحديـث السورس بنجاح 👍🏿\n👾¦ أكتب `اصدار السورس` للتأكيد🕵🏼️‍♀️\n👨🏾‍🔧¦ تابع القناة @DevJason \n👨🏻‍💻¦حته هم تشوف الشغلات الجديده \n🛠¦الي تنزل للسورس العراب🍃"
